...
public class Pop {
    ...
    private void createDialog(boolean backgroundInvisible) {
        if (yah != null) {
    ...
    public AlertDialog showWithInvisibleBackground() {
        createDialog(true);
        return alertDialog;
    }

    public AlertDialog showWithInvisibleBackground(@NonNull Pop.View popView) {
        popView.prepare(lView);
        createDialog(true);
        return alertDialog;
    }
